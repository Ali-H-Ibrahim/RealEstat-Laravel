    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item ">
                    <a class="navbar-brand" a href="{{route('adminDashboard')}}">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('admin/images/logo/house.png')}}">
                        <h3 class="brand-text red">DAR <span class="black"> Admin</span></h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرحباً
                  ...
                  <img  style="height: 35px;" src="{{asset('admin/images/pages/editor-1.jpg')}}" alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('adminSettings')}}"><i
                                    class="ft-user"></i> تعديل الملف الشحصي </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('adminLogout')}}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                        </div>
                    </li>
