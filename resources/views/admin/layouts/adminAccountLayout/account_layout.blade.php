    ...
    <div class="container-login100">
        <div class="wrap-login100 p-t-50 p-b-90">
            ...
            <img class="brand-logo" alt="modern admin logo"
                 src="{{asset('admin/images/logo/house2.png')}}" width="100" height="100">
            <label style="color:red"> DAR <span style="color:black"> Admin</span></label>
            <br>
            <br>
