                            ...
                            <div class="card-content">
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 pl-2">
                                            <h4>عدد الابنية المباعة</h4>
                                            <h6 class="text-muted"></h6>
                                        </div>
                                        <div class="col-5 text-right">

                                            <h3 class="success darken-4"><i class="la la-arrow-up">10</i></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="card-body pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            ...
                                            <h6 class="danger">نور الجوراني<i class="la"></i></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
