...
@section('admin_content')
    ...
    <div class="app-content content">
        ...
        <form action="{{route('update.property',$property->id)}}" method="post" id="productForm" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row">
                    <!-- Brand -->
                    <div class="col-md-4 pt-2">
                        <img src="{{asset("images/".$property->main_image)}}" width="150" height="150">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="form-group col-sm-4 col-12 ">
                        ...
                        <input type="text" class="form-control fieldForm info" name="type"  value="{{$property->type}}" placeholder="type">
                    ...
                    <div class="form-group col-sm-4 col-12 ">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->area}}" name="area" placeholder="area">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->price}}" name="price" placeholder="price">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->number_of_rooms}}"  name="number_of_rooms" placeholder="number of rooms">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->number_of_bathrooms}}"  name="number_of_bathrooms" placeholder="number of bathrooms">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->dimension_of_the_city}}"  name="dimension_of_the_city" placeholder="dimension of the city">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->dimension_of_the_school}}" name="dimension_of_the_school" placeholder="dimension of the school">
                    ...
                    <div class="form-group col-sm-4 col-12">
                        ...
                        <input type="text" class="form-control fieldForm info" value="{{$property->dimension_of_the_market}}" name="dimension_of_the_market" placeholder="dimension of the marketd">
                    ...
                    <div class="form-group col-sm-9 col-12 ">
                        ...
                        <textarea rows="8" type="text" class="form-control fieldForm info" value="{{$property->owner_description}}" name="owner_description"
