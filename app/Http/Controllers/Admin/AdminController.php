...
class AdminController extends Controller
{
    ...
    public function postLogin(Request $request)
    {
        ...
        $data = $request->input();
        if (auth()->guard('admin')->attempt(['email' => $data['email'], 'password' => $data['password'], 'role' => 1])) {
    ...
    public function Site_settings()
    {
        ...
        $max_num= env('maximum_number_free_property');
        return view('admin.Site_settings.pageSettings',compact('max_num'));
