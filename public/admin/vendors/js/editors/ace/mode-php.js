...
var functionMap = {
    ...
    "array_product": [
        ...
        "Returns the property of the array entries"
    ],
    "array_push": [
    ...
    "dcgettext": [
        "string dcgettext(string domain_name, string msgid, long city)",
        "Return the translation of msgid for domain_name and city, or msgid unaltered if a translation does not exist"
    ],
    "dcngettext": [
        "string dcngettext (string domain, string msgid1, string msgid2, int n, int city)",
    ...
    "setlocale": [
        "string setlocale(mixed city, string locale [, string ...])",
