/*=========================================================================================
    File Name: city-data.js
    Description: c3 city data chart
    ----------------------------------------------------------------------------------------
...
$(window).on("load", function(){
    ...
    // Callback that creates and populates a data table, instantiates the city data chart, passes in the data and draws it.
